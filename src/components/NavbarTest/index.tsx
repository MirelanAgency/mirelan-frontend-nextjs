...
export function StickyNavbar() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        ...
        variant="paragraph"
        color="black"
        className="p-1 font-normal font-medium"
      >
      ...
      <div className="hidden xl:flex border-r border-black p-2"/>
      <Typography
      placeholder=""
        as="li"
        variant="paragraph"
  ...
  return (
    <div className="max-h-[768px] w-[calc(100%)]">
      <Navbar placeholder="" shadow={false} color="transparent" fullWidth={true} className="sticky bg- top-0 z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4">
